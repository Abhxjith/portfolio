    ...
    <section className="highlights-section">
      <div className="section-title-wrapper">
        <h2 className="section-title">
          <BlurredStagger text="highlights!" />
        </h2>
        <svg
      ...
      <div className="carousel-container">
        ...
        <div
          className="carousel-track-container carousel-container-query"
          ...
          {count > 0 ? (
            ...
            >
              {highlights.map((project) => (
                <div
                  key={project._id}
                  className="carousel-slide carousel-slide-double"
                  style={{ flex: `0 0 calc((100cqw - 16px) / 2)` }}
                >
                  <a
                    href={project.link || "#"}
                    target="_blank"
                  ...
                  >
                    {project.mediaType === "image" && project.image && (
                      ...
                      <img
                        src={urlFor(project.image).width(640).auto("format").quality(72).url()}
                        alt={project.title}
                        style={{
                          width: "100%",
                          height: "100%",
